@extends('navbarAdmin')
@section('contenu1')
    <form action="{{route('chemin_validerAjtProjet')}}" enctype="multipart/form-data">
        <table class="table table-striped table-condensed" id ="projet">
            <thead>
            <tr>
            ...
            <tr>
                ...
                <td><input name="images" type="text" /></td>
