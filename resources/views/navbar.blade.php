...
@section('navbar')
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark" style="width: 100%;" id="navbar">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="{{route('chemin_accueil')}}">
            ...
            <div class="collapse navbar-collapse justify-content-end text-white" id="navbarVisiteur">
                <ul class="navbar-nav" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('chemin_listeStages') }}">Stage</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('chemin_info')}}">À propos de moi</a>
                    </li>
